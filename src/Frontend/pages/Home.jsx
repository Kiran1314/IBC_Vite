   ...
   <>
    ...
    <img src={Herobgshp} alt="shape"/> */}
             ...
             />
              ...
              <div className="hero-shape"><img src={Heroshp} alt="shape" /></div>
          ...
          </section><section className="process-section pt-130 fade-wrapper" style={{ position: 'relative' }}>



              <div className="bg-shape"><img src={Processshp} alt="shape" />
              ...
              <div>
                  ...
                  <div className="floating" style={{ zIndex: 9999, position: 'absolute' }}>
                      <img src={Dronefly} alt="Drone" style={{ width: 500 }} />
                  </div>
        ...
        <section className="about-section pb-130">
            <div className="round-shape"><img src={RoundShp} alt="shape"/></div>
            <div className="about-wrap">
                <div className="shape"><img src={Aboutdotshp} alt="shape"/></div>
                    ...
                    <div className="col-lg-5">
                        <div className="about-img-wrap">
                            ...
                            <div className="about-img ">
                                <img className="img-1" src={Aboutimg} alt="img"/>
                            </div>
         ...
         <div className="shape"><img src={serviceshp1} alt="shape"/></div>
                    ...
                    <div className="col-lg-3 col-md-6">
                        <div className="service-item md-pb-30">
                            ...
                            <div className="service-thumb">
                                ...
                                <div className="transparent-shape"><img src={serviceshp} alt="shape"/></div>
        ...
        <section className="faq-section pt-130 pb-130">
            <div className="faq-shape"><img src={faqshp1} alt="shape"/></div>
        ...
        <section className="process-section pt-130 fade-wrapper">
            <div className="bg-shape"><img src={processhp} alt="shape"/></div>
            <div className="container">
                <div className="section-heading text-center">
        ...
        >
            <Slider.Slide>
                <img src={client1} alt="Client" className='w-36' />
            </Slider.Slide>
            <Slider.Slide>
                <img src={client2} alt="Client" className='w-36' />
            </Slider.Slide>
            <Slider.Slide>
                <img src={client3} alt="Client" className='w-36' />
            </Slider.Slide>
            <Slider.Slide>
                <img src={client4} alt="Client" className='w-36' />
            </Slider.Slide>
            <Slider.Slide>
                <img src={client5} alt="Client" className='w-36' />
            </Slider.Slide>
            <Slider.Slide>
                <img src={client6} alt="Client" className='w-36' />
            </Slider.Slide>
            <Slider.Slide>
                <img src={client7} alt="Client" className='w-36' />
            </Slider.Slide>
            <Slider.Slide>
                <img src={client8} alt="Client" className='w-36' />
            </Slider.Slide>
            <Slider.Slide>
                <img src={client9} alt="Client" className='w-36' />
            </Slider.Slide>
            <Slider.Slide>
                <img src={client10} alt="Client" className='w-36' />
            </Slider.Slide>
            <Slider.Slide>
                <img src={client11} alt="Client" className='w-36' />
            </Slider.Slide>
            <Slider.Slide>
                <img src={client12} alt="Client" className='w-36' />
            </Slider.Slide>
            <Slider.Slide>
                <img src={client13} alt="Client" className='w-36' />
            </Slider.Slide>
            <Slider.Slide>
                <img src={client14} alt="Client" className='w-36' />
            </Slider.Slide>
            <Slider.Slide>
                <img src={client15} alt="Client" className='w-36' />
            </Slider.Slide>
            <Slider.Slide>
                <img src={client16} alt="Client" className='w-36' />
            </Slider.Slide>
        </Slider>
        </div>
